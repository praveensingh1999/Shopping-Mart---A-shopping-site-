        ...
        <div className="container">
            <div className='flex items-center justify-between'>
               <div className='col1 w-[50%]'>
                <p className='text-[14px]font-[500]'>Get up to 50% off on new season styles, limited time offers</p>
               </div>
    ...
    <div className='header py-3'>
        <div className='container flex items-center justify-between'>
            <div className='col1 w-[30%]'>
                  <Link to={"/"}><img src='/src/assets/logoshoppingmart.jpg' /></Link>
            </div>
            <div className='col2 w-[40%]'>
                <Search/>
            </div>
            <div className="col3 w-[30%] flex items-center pl-25">
